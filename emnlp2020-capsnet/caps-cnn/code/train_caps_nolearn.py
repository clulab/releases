...
saveDirectory = "/tmp/caps_nolearn_"+LANGUAGE+"_"+TRAIN_AMOUNT+"_"+random_seed
...
testFunc = "CapsNet_for_NER/code/trainCapsModel.py"
...
print("Training Time for capsnet nolearn")
