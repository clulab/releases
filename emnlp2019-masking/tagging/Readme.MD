...
- download data file from [here](http://clulab.cs.arizona.edu/data/emnlp2019-delex/http://clulab.cs.arizona.edu/data/emnlp2019-delex/fever_dev_lex_3labels_26k_no_lists_evidence_not_sents.jsonl)
