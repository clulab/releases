...
import edu.arizona.sista.qa.discourse.DiscourseModelTree._
 ...
 * Date: 12/12/13
 */
class DiscourseModelTreeBackoff (val props:Properties) extends RankingModel {
...
object DiscourseModelTreeBackoff {
  val logger = LoggerFactory.getLogger(classOf[DiscourseModelTreeBackoff])
}
