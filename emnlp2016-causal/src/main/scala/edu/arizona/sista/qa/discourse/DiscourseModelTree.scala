 ...
 * Date: 8/7/13
 */
class DiscourseModelTree(val props:Properties) extends RankingModel {
  ...
  lazy val minScoreThresh = StringUtils.getDouble(props, "discourse.match_threshold_tree", 0.20)
