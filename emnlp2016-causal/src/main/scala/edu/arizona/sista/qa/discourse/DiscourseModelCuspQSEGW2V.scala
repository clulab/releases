 ...
 * Date: 12/10/13
 */
class DiscourseModelCuspQSEGW2V(props:Properties) extends RankingModel {
...
object DiscourseModelCuspQSEGW2V {
  val logger = LoggerFactory.getLogger(classOf[DiscourseModelCuspQSEGW2V])
}
